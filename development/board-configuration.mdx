...
### [RGB LEDs](../web-configurator/menu-pages/led-configuration/#rgb-led-configuration)
...
### [Player LEDs](../web-configurator/menu-pages/led-configuration/#player-leds-xinput)
...
### [I2C Displays](../web-configurator/menu-pages/display-configuration)
