...
- `Inner Deadzone Size (%)` - Enter the % value of inner dead zone you would like on the analog joysticks.
- `Outer Deadzone Size (%)` - Enter the % value of outer dead zone you would like on the analog joysticks.
