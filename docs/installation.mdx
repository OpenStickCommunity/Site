...
3. Put your device into Bootsel/USB mode by pressing the Bootsel button or holding <Hotkey buttons={["S1", "B3", "B4"]} /> for 5 seconds. A new removable drive named `RPI-RP2` should appear in your file explorer.
...
2. Put your device into Bootsel/USB mode by pressing the Bootsel button or holding <Hotkey buttons={["S1", "B3", "B4"]} /> for 5 seconds. A new removable drive named `RPI-RP2` should appear in your file explorer.
