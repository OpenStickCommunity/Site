...
If you're installing boards with GP2040-CE in an arcade cabinet, check out the [Gamepad settings](../web-configurator/menu-pages/01-settings.mdx) to change the USB attributes for unique X-Input and USB HID device settings.
