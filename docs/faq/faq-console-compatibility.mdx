...
PS5 Input Mode is an input mode that grants GP2040-CE compatibility with the Playstation 4 or Playstation 5 console by using a compatible controller or dongle to answer authentication.
...
Xbox One Input Mode grants GP2040-CE compatibility with the Xbox One, Xbox Series S, or Xbox Series X by using a compatible dongle to answer authentication.
