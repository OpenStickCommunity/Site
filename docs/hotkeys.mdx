...
TODO Verify that `Profile Settings` link is functional
...
The A1 Button hotkey is distinct from the [Touchpad Button](#touchpad-button) hotkey as this hotkey will trigger either the Touchpad button or Share button depending on whether the toggle for [`Switch Touchpad and Share`](./web-configurator/menu-pages/01-settings.mdx#switch-touchpad-and-share) is on or off.

TODO Verify that `Switch Touchpad and Share` is functional
