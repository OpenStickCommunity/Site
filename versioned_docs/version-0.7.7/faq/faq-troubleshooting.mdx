...
#### Did not press <Hotkey buttons={["A1"]} /> after connecting the controller.
...
### I don't have a <Hotkey buttons={["S2"]} /> button and cannot get to WebConfig using the shortcuts. How do I get to the Web Configurator?
